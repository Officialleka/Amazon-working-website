...
getPrice () {
 return `$${moneyDenom(this.priceCents)}`;
}

extraInfoAboutClothingHTML() {
  return '';
}
...
this.a returns undefined(error code) at the point in the code,the object has not yet been created
*/
...
export class Clothing extends Product{
 ...
 extraInfoAboutClothingHTML() {
  //super.extraInfoAboutClothingHTML();
   return `
...
/*export const products = [
  ...
  },
  {
    ...
    type: "appliance",
    instructionsLink: "images/appliances-instructions.png",
